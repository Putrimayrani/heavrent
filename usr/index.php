<<?php
    ...
    if(isset($_POST['Usr-login']))
    {
        ...
        $stmt->close(); // close the result set before executing the next query
        ...
        if($rs)
        {
            ...
            $log="INSERT INTO tms_syslogs(u_id, u_email, u_ip, u_city, u_country) VALUES ('$uid','$uemail','$ip','$city','$country')";
...
<head>
  ...
  <title>heavrent - Client Login</title>
